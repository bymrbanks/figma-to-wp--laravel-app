...
//         // Redirect to OAuth provider with state parameter (write key)
...
//     public function getWriteKey(Request $request)
//     {
//         $writeKey = $request->input('writeKey');
//         $readKey = Cache::get($writeKey);

//         if ($readKey) {
//             return response()->json(['readKey' => $readKey]);
//         } else {
//             return response()->json(['error' => 'Read key not found'], 404);
//         }
//     }
